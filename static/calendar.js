...
Calendar.SECOND = 1000 /* milliseconds */;
Calendar.MINUTE = 60 * Calendar.SECOND;
Calendar.HOUR = 60 * Calendar.MINUTE;
Calendar.DAY = 24 * Calendar.HOUR;
Calendar.WEEK = 7 * Calendar.DAY;
...
Date.prototype.getDayOfYear = function () {
	...
	var time = now - then;
	return Math.floor(time / Calendar.DAY);
};
...
Date.prototype.getWeekNumber = function () {
	...
	if (day == 0) day = 7;
	(day > 4) && (day -= 4) || (day += 3);
	return Math.round(((time / Calendar.DAY) + day) / 7);
};
